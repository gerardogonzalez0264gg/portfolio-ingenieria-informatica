...
ip no domain lookup: evita que al escribir mal se te pegue por un minuto

logging synchronous: evita que salgan mensajes d conexiones mientras escribes código
